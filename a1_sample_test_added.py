...
def test_random_arrival_generator() -> None:
    """Test the random arrival generator for two rounds: 0 and 5.
...
def test_random_moving_no_elevator() -> None:
    """Test the random moving algorithm.
...
def test_pushy_passenger_one_elevator_per_person() -> None:
    """Test the Pushy Passenger algorithm test with sample_arrivals.csv.
...
def test_pushy_passenger_no_elevator() -> None:
    """Test the Pushy Passenger algorithm test with sample_arrivals.csv.
...
def test_short_sighted_one_elevator() -> None:
    """Test the Short-Sighted algorithm test with sample_arrivals.csv.
...
def test_short_sighted_no_elevator() -> None:
    """Test the Short-Sighted algorithm test with sample_arrivals.csv.
